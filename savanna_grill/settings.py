"""
Django settings for savanna_grill project.
...
SECRET_KEY = 'django-insecure--f0i(ujji#u_-xfrmarvjdi@vvxq96j-l5n+&j!5m=h&a-c##l'
...
ROOT_URLCONF = 'savanna_grill.urls'
...
WSGI_APPLICATION = 'savanna_grill.wsgi.application'
